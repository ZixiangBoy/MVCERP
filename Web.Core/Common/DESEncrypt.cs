...
namespace Web.Core.Common
{
    ...
    public class DESEncrypt
    {
        ...
        private static string DefaultKey
        {
            get
            {
                return
                   ...
                   HashDigest.StringDigest("Web.Core.Common-Serct-Key", DigestType.MD5));
            }
        }
        ...
        public static byte[] Encrypt(byte[] srcData, string strKey)
        {
            //将密钥散列
        ...
        public static byte[] Decrypt(byte[] srcData, string strKey)
        {
        ...
        public static string EncryptString(string srcString, string strKey)
        {
        ...
        public static string DecryptString(string srcString, string strKey)
        {
        ...
        {
            return EncryptString(srcStr, DESEncrypt.DefaultKey);
        }
        ...
        /// <param name="srcStr"></param>
        /// <returns></returns>
        public static string DecryptString(string srcStr)
        {
            return DecryptString(srcStr, DESEncrypt.DefaultKey);
        }
    }
}
